...
import 'package:virtual_store_flutter_app/tiles/product_tile.dart';
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
          ...
          //DocumentSnapshot é uma fotografia de um doc
          //Um query, é uma fotografia de toda uma coleção.
            ...
            builder: (context, snapshot) {
              if (!snapshot.hasData) {
                ...
                return TabBarView(
                  ...
                  children: [
                    //Carrega de pouco em pouco para não pesar a tela.
                    GridView.builder(
